...
const Head = () => {
    return (<>
        ...
        <section class="text-gray-600 body-font ">
            <div class="container mx-auto flex px-5 pt-32 py-16 md:flex-row md:text-center flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pl-4 pr-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <img class="border-2 border-blue-700 object-cover object-center rounded-tl-full" alt="hero" src={LaparoscopicImage}/>
                </div>
            </div>
        </section>
    </>
