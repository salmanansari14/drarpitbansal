...
const Head = () => {
    return (<>
        <NavigationB />
        <section class="text-gray-600 body-font bg-gradient-to-r from-blue-300">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:max-w-lg  lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <img class="object-cover rounded-tr-3xl object-center rounded-tr-full" alt="hero" src={LaparoscopicImage}/>
                </div>
