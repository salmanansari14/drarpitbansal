...
const Head = () => {
    return (<>
        <NavigationB />
        <section class="text-gray-600 body-font bg-gradient-to-r from-blue-400">
            <div class="container mx-10 flex px-5 py-28 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pl-24 pr-28 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Laparoscopic & Laser Surgery
                    </h1>
